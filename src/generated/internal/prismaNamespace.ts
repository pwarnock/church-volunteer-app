...
> = {
  ...
  meta: {
    modelProps: 'user' | 'volunteerProfile' | 'opportunity' | 'application';
    ...
    VolunteerProfile: {
      ...
      operations: {
        ...
        count: {
          ...
          result:
            | runtime.Types.Utils.Optional<Prisma.VolunteerProfileCountAggregateOutputType>
            | number;
        };
      };
    };
...
export type VolunteerProfileScalarFieldEnum =
  (typeof VolunteerProfileScalarFieldEnum)[keyof typeof VolunteerProfileScalarFieldEnum];
