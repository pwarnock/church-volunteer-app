                  ...
                  <div className="flex items-center text-gray-500">
                    ...
                    >
                      <path
                        ...
                        strokeLinejoin="round"
                        strokeWidth={2}
                        d="M8 7V3m8 4V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"
                      />
                    </svg>
                    Starts{' '}
                    ...
                    <div key={app.id} className="border rounded-lg p-4">
                      ...
                      {app.volunteer.profile && (
                        <div className="mb-3">
                          ...
                          <p className="text-sm text-gray-600">
                            {app.volunteer.profile.spiritualGifts ||
                              'Not specified'}
                          </p>
                        </div>
                      )}
