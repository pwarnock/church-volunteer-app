              ...
              <div className="bg-white rounded-lg shadow-lg p-8">
                <div className="text-center">
                  ...
                  <p className="text-gray-600 mb-6">
                    Take our assessment to discover your spiritual gifts and
                    find the perfect place to serve.
                  </p>
                  <Link
            ...
            <>
              <div className="bg-white rounded-lg shadow-lg p-8">
                <div className="text-center">
                  ...
                  <p className="text-gray-600 mb-6">
                    Post new volunteer opportunities for your ministry and
                    recruit passionate servants.
                  </p>
                  <Link
                    href="/leader"
              ...
              <div className="bg-white rounded-lg shadow-lg p-8">
                <div className="text-center">
                  ...
                  <p className="text-gray-600 mb-6">
                    Review and manage volunteer applications for your ministry
                    opportunities.
                  </p>
                  <Link
