...
Given('ministry opportunities exist in the database', function () {
  opportunities = [
    { id: '1', title: 'Sunday School Teacher', ministry: "Children's Ministry", status: 'ACTIVE' },
    { id: '2', title: 'Community Outreach', ministry: 'Outreach', status: 'ACTIVE' },
    { id: '3', title: 'Youth Group Mentor', ministry: 'Youth', status: 'ACTIVE' },
  ]
...
Given('opportunities from different ministries exist', function () {
  opportunities = [
    { id: '1', title: 'Sunday School Teacher', ministry: "Children's Ministry" },
...
Given('I have already applied for {string}', function (opportunityTitle: string) {
...
Given('I have submitted applications for {int} opportunities', function (count: number) {
  applications = Array(count).fill(null).map((_, i) => ({
    opportunityId: `app${i}`,
    status: 'PENDING',
  }))
...
Then('each opportunity should display title, description, and ministry type', function () {
...
Then('I should only see opportunities from {string}', function (ministry: string) {
  opportunities.forEach((opp) => {
...
Then('each should show the status \\(pending, accepted, rejected\\)', function () {
...
Then('each requirement should be clearly marked as required or optional', function () {
  expect(true).toBe(true)
})
